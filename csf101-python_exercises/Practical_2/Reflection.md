Documentation
Main Concepts Applied In this practical, I explored:
...
I finally figured out my main problem with recursion: I didn't understand how the function stops! My program kept running forever because I forgot to include the base case (the rule that tells it to stop, like n=0 or n=1). Once I realized that recursion absolutely needs a stopping condition, it all clicked. I also learned how useful planning is when I spotted small mistakes in my logic while writing pseudocode—things like using the wrong symbol for comparison versus setting a value. Looking at the flowchart helped me catch and fix those errors before I even started writing the actual computer code."
